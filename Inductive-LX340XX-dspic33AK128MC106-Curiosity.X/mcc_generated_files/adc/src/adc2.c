...
void ADC2_Initialize(void)
{
    ...
    AD2SWTRG = 0x0UL;
    //TRG1SRC Software trigger initiated using ADnSWTRG register; SAMC 0.5 TAD; NINSEL disabled; LEFT Integer; PINSEL AD2AN1; DIFF disabled; CMPMOD NONE; TRG2SRC disabled; EIEN disabled; TRG1POL disabled; ACCRO disabled; ACCBRST disabled; ACCNUM 4 samples, 13 bits result; MODE Single sample initiated by TRG1SRC[4:0] trigger; 
    AD2CH0CON = 0x801UL;
    //TRG1SRC Software trigger initiated using ADnSWTRG register; SAMC 0.5 TAD; NINSEL disabled; LEFT Integer; PINSEL AD2AN4; DIFF disabled; CMPMOD NONE; TRG2SRC disabled; EIEN disabled; TRG1POL disabled; ACCRO disabled; ACCBRST disabled; ACCNUM 4 samples, 13 bits result; MODE Single sample initiated by TRG1SRC[4:0] trigger; 
    AD2CH1CON = 0x2001UL;
...
void ADC2_PWMTriggerSourceSet(enum ADC2_CHANNEL channel, enum ADC_PWM_INSTANCE pwmInstance, enum ADC_PWM_TRIGGERS triggerNumber)
{
    ...
    {
        case ADC2_Channel0:
                AD2SWTRGbits.CH0TRG = adcTriggerValue;
                break;
        case ADC2_Channel1:
                AD2SWTRGbits.CH1TRG = adcTriggerValue;
                break;
        default:
                break;
    }
...
void __attribute__ ( ( __interrupt__ , auto_psv, weak ) ) _AD2CH0Interrupt ( void )
{
...
void __attribute__ ( ( __interrupt__ , auto_psv, weak ) ) _AD2CH1Interrupt ( void )
{
